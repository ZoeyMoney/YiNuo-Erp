<template>
    <div class="Project_Reconciliation">
     ...
     <div class="all-hoh" style="padding-bottom:30px;font-size: 14px;">
          <div class="all-name">工地名称：</div>
          <div class="all-name">施工时间：26</div>
          <div style="height: 300px;padding-left:25%;padding-bottom:30px;">
        <el-steps direction="vertical" :active="2">
          <el-step title="步骤 1" ></el-step>
          <el-step title="步骤 2"></el-step>
          <el-step title="步骤 3" style="font-weight:0;"></el-step>
        </el-steps>
</div>
      <el-col :span="12">
          <span class="demonstration">共计人工</span>
          <el-dropdown trigger="click">
            <span class="el-dropdown-link">
              <i class="el-icon-arrow-down el-icon--right"></i>
            </span>
            <el-dropdown-menu slot="dropdown" >
              <el-dropdown-item >木工：</el-dropdown-item>
              <el-dropdown-item >水电工：</el-dropdown-item>
              <el-dropdown-item >杂工：</el-dropdown-item>
...
.Project_Reconciliation{
  ...
  .all-hot  {padding-bottom: 10px;}
  .all-hoh  {padding-bottom: 10px;}
  .all-name {margin-bottom: 20px;}
