  ...
  <div class="payable_pay">
    ...
    <div class="mui-content app">
      <form class="mui-input-group">
        ...
        <div class="mui-input-row">
          <label>首款备注</label>
          <input type="text" class="mui-input-clear" placeholder="备注" v-model="text" disabled="disabled">
        </div>
        <div class="mui-input-row">
          <label>时间</label>
          <input type="date" class="mui-input-clear" :value="date">
        </div>
      </form>
      <form class="mui-input-group">
        <div class="mui-input-row">
