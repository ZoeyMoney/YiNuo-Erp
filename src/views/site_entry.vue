<template>
    <div class="site_entry">
      ...
      <!--客户详情-->
      <login-loading v-show="img_show"></login-loading>
      ...
      <div class="mui-content app">
        <form class="mui-input-group">
          ...
          <div class="mui-input-row">
            ...
            <select name="" v-model="psName" :class="{classGary:psName=='',classBlack:psName!=''}">
              <option value="">请选择</option>
              <option v-for="item in ps" :value="item.fund_person_id">{{item.fund_person}}</option>
            </select>
          </div>
          <div class="mui-input-row">
            <label>装修面积</label>
          ...
          <div class="mui-input-row radio-form">
            <div class="mui-input-row mui-radio mui-left go-label">
              <label>所属类型</label>
              <input type="text" class="mui-input-clear" v-model="Customer_type" name="Customer_type"
                     placeholder="所属类型">
            </div>
        ...
        <form class="mui-input-group">
          <div class="mui-input-row">
            <label>项目经理</label>
            <select name="" v-model="projetManager" :class="{classGary:projetManager=='',classBlack:projetManager!=''}">
              <option value="">请选择</option>
              <option v-for="(item,i) in list_projetManager" :value="item.fund_person_id" :key="i">
                {{item.fund_person}}
              </option>
            </select>
          </div>
          <div class="mui-input-row">
            ...
            <select name="" v-model="engineering" :class="{classGary:engineering=='',classBlack:engineering!=''}">
              <option value="">请选择</option>
              <option v-for="(item,i) in list_engineering" :value="item.fund_person_id" :key="i">{{item.fund_person}}
              </option>
            </select>
          </div>
          <div class="mui-input-row">
...
<!--            <input type="date" class="mui-input-clear" v-model="contractDate" placeholder="input">-->
            <el-date-picker v-model="contractDate" type="date" placeholder="选择日期"></el-date-picker>
          </div>
