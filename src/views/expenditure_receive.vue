<template>
    <div class="expenditure_receive">
      ...
      <header class="mui-bar mui-bar-nav">
        <router-link :to="{name:'expenditure'}" class="mui-icon mui-icon-left-nav mui-pull-left"></router-link>
...
export default {
  ...
  methods: {
    ...
    // 工地
    siteChange () {
      var expenditure = 'expenditure_receive'
      this.$router.push({ path: 'siteList' })
      window.expenditure = expenditure
    },
    // 相关人
    relecantProsen () {
      var prosen = 'expenditure_receive'
